        ...
        <div class="container-fluid px-4">
            ...
            <div class="card mb-4">
                <div class="card-header bg-primary text-white">
                    <i class="fas fa-table me-1"></i> Edit Products
                </div>
                <div class="card-body">
                        ...
                        <tbody>
                            <?php while ($row = mysqli_fetch_array($result)) { ?> 
                                <tr>
                                    ...
                                    <td>
                                        <a href="product_edit_process.php?id=<?php echo $row['p_id']; ?>">
                    ...
                    <div style="display:flex; justify-content:space-between; align-items:center;">
                        <div>
                            <p>Showing <?php echo min($start + $limit, $total_records); ?> of <?php echo $total_records; ?> entries</p>
                        </div>
                        <div>
